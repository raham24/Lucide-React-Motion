 ...
 *
 * **Real-life motion**: a single clockwise 360° revolution of the
 * whole icon, eased in/out. Full revolution (rather than the
 * family's quarter-turn) reads as "spinning in three dimensions"
